...
public class VideoView extends SurfaceView implements
	...
	private Uri mUri;
	private int mVideoResID = -1; // 视频资源放在raw目录
	...
	public void setVideoRaw(int resid) {
		mVideoResID = resid;
		mSeekWhenPrepared = 0;
		openVideo();
		requestLayout();
	...
	private void openVideo() {
		if ((mUri == null && mVideoResID == -1) || mSurfaceHolder == null)
			return;
